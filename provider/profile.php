...
// Check if current user has approved selection
$isApproved = false;
if (isLoggedIn()) {
    $user = getCurrentUser();
...
<head>
    ...
    <title><?php echo htmlspecialchars($provider['name']); ?> - <?php echo $currentLang === 'en' ? 'Service Provider' : 'সেবা প্রদানকারী'; ?> - Home Service</title>
                    ...
                    <div class="profile-card p-6 mb-6">
                        ...
                        <?php if ($isApproved): ?>
                            ...
                            <div class="space-y-3">
                                ...
                                <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $provider['phone']); ?>?text=<?php echo urlencode($currentLang === 'en' ? 'Hi, I am interested in your services. Can you provide more details?' : 'হাই, আমি আপনার সেবায় আগ্রহী। আপনি কি আরও বিস্তারিত দিতে পারেন?'); ?>" 
                                   target="_blank"
                        ...
                        <?php else: ?>
                            <div class="p-4 bg-amber-50 border border-amber-200 rounded-xl mb-6 flex items-start">
                                <i class="fas fa-lock text-amber-500 mr-3 mt-1 text-lg"></i>
                                <div>
                                    <p class="text-sm text-amber-800 font-medium leading-tight">
                                        <?php echo $currentLang === 'en' 
                                            ? 'Admin approval required before you can contact this provider. You will be notified once approved.' 
                                            : 'এই প্রদানকারীর সাথে যোগাযোগ করার আগে অ্যাডমিন অনুমোদনের প্রয়োজন। অনুমোদিত হলে আপনাকে জানানো হবে।'; ?>
                                    </p>
                                </div>
                            </div>
