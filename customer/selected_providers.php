...
<head>
    ...
    <title><?php echo $currentLang === 'en' ? 'Selected Providers' : 'নির্বাচিত প্রদানকারী'; ?> - HOME SERVICE</title>
...
<body class="bg-gray-50">
        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <a href="../index.php" class="text-2xl font-bold text-purple-600">HOME SERVICE</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="dashboard.php" class="text-black hover:text-gray-800">
    ...
    <footer class="bg-gray-800 text-white py-8 mt-12">
        <div class="container mx-auto px-4 text-center">
            <p>&copy; 2024 HOME SERVICE. <?php echo $currentLang === 'en' ? 'All rights reserved.' : 'সর্বস্বত্ব সংরক্ষিত।'; ?></p>
        </div>
    </footer>
</body>
</html> 